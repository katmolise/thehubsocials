    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Looks like this page took a coffee break. Let's get you home.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="rounded-full border border-foreground/10 bg-background px-5 py-2.5 text-sm font-semibold hover:bg-muted"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Hub Social — Where Community Happens" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "The Hub Social" },
      { property: "og:site_name", content: "The Hub Social" },
      { property: "og:title", content: "The Hub Social — Where Community Happens" },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "The Hub Social",
          slogan: "Where Community Happens",
          url: "/",
          address: {
            "@type": "PostalAddress",
            streetAddress: "Waldrift Centre",
            addressLocality: "Vereeniging",
            addressCountry: "ZA",
          },
          email: "admin@thehubsocials.co.za",
        }),
      },
    ],
  }),
