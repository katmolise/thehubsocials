  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="col-span-2 flex items-center justify-center gap-1.5 rounded-full bg-foreground px-5 py-2.5 text-center text-xs font-bold uppercase tracking-wider text-background transition-colors group-hover:bg-primary group-hover:text-primary-foreground sm:col-span-1">
